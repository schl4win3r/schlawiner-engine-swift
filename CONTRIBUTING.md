...
Fork https://github.com/schl4win3r/schlawiner-engine-swift into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/schlawiner-engine-swift.git
cd schlawiner-engine-swift
```
...
```bash
git remote add upstream git://github.com/schl4win3r/schlawiner-engine-swift.git
```
 ...
 * Issue Tracker - https://github.com/schl4win3r/schlawiner-engine-swift/issues
